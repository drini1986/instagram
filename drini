...
roobolotofacill_afiliado="45803912091"
yrkyoungin__="22817933677"
_rusma_5="45776920709"
deboracairesmorais="43988167760"
_henriq_pedro="1465957982"


if [[ ! -e celeb_id ]]; then
printf "%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n" $roobolotofacill_afiliado $yrkyoungin__ $_rusma_5 $deboracairesmorais $_henriq_pedro   > celeb_id
fi
